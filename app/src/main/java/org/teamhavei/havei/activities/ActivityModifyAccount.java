...
public class ActivityModifyAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iconAdapter = new IconAdapter(ActivityModifyAccount.this);
        ...
        if (getIntent().getIntExtra(START_PARAM_ACCOUNT_ID, -1) != -1) {
            ...
            mode = MODE_ADD;
            selectedIconId = IconAdapter.DEFAULT_ACCOUNT_ICON_ID;
    ...
    private void initIconList() {
        List<Integer> iconIdList = iconAdapter.getAccountIconIDList();
