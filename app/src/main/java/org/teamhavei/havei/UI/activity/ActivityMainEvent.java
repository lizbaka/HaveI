...
import org.teamhavei.havei.UI.adapter.TodoCardAdapter;
...
public class ActivityMainEvent extends BaseActivity {
    ...
    private void updateSelectedDate() {
        dateSelectorDateTV.setText(Util.eventDateFormatter(calendar.getTime()));
        todoDateTV.setText(Util.eventDateFormatter(calendar.getTime()).substring(5));
    ...
    private void configHabitContainerGL() {
        ...
        View child;
        IconManager iconManager = new IconManager(ActivityMainEvent.this);
        ...
        for (int i = 0; i < (Math.min(todayHabitList.size(), 4)); i++) {
            ...
            iconIV.setImageDrawable(iconManager.getIcon(dbHelper.findEventTagById(mHabit.getTagId()).getIconId()));
