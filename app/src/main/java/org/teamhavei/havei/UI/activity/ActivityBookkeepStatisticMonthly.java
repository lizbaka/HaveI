...
public class ActivityBookkeepStatisticMonthly extends BaseActivity {
    ...
    private void updateData() {
        dateTV.setText(Util.eventYearMonthFormatter(calendar.getTime()));
        ...
        setmyPIE(chart_in, "收入", Util.BOOKKEEP_TAG_INCOME, calendar.getTime());
        setmyPIE(chart_out, "支出", Util.BOOKKEEP_TAG_EXPENDITURE, calendar.getTime());
    }
