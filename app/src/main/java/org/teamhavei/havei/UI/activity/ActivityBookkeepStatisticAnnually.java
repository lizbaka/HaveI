...
import org.teamhavei.havei.UI.DoubleLineManager;
...
public class ActivityBookkeepStatisticAnnually extends AppCompatActivity {
    ...
    public void setmyDOULINE(Date mDate, LineChart mLine) {
        ArrayList<Double> data1 = dbHelper.getPMListByYear(Util.BOOKKEEP_TAG_INCOME, mDate);
        ArrayList<Double> data2 = dbHelper.getPMListByYear(Util.BOOKKEEP_TAG_EXPENDITURE, mDate);
