package org.teamhavei.havei.service;
...
import org.teamhavei.havei.UI.activity.ActivityMain;
import org.teamhavei.havei.UI.activity.ActivityTodoDetail;
...
public class HaveITimeWatcher extends Service {
    ...
    private void checkTodo() {
        ...
        for (Todo i : todoList) {
            ...
            Notification notification = new NotificationCompat.Builder(this, Util.TODO_NOTIFICATION_CHANNEL_ID)
    ...
    private void checkHabit() {
        ...
        for (Habit i : habitList) {
            ...
            Notification notification = new NotificationCompat.Builder(this, Util.HABIT_NOTIFICATION_CHANNEL_ID)
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Notification fgNotification =
                new NotificationCompat.Builder(this, Util.BASIC_NOTIFICATION_CHANNEL_ID)
                        .setContentTitle(getString(Util.getGreetingTimeId()))
                        .setContentText(getString(Util.getGreetingSecId()))
                        .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.mipmap.havei_launcher_foreground))
                        .setSmallIcon(R.mipmap.havei_launcher_foreground)
                        .setContentIntent(pi)
                        .build();
