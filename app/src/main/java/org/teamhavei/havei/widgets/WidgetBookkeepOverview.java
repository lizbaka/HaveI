package org.teamhavei.havei.widgets;
...
import org.teamhavei.havei.activities.ActivityBookkeep;
...
public class WidgetBookkeepOverview extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        pref = context.getSharedPreferences(UniToolKit.PREF_SETTINGS, Context.MODE_PRIVATE);
        ...
        remainBudget = pref.getFloat(UniToolKit.PREF_BUDGET, 0);
